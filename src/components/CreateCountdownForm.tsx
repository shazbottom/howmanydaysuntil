...
export function CreateCountdownForm() {
  ...
  return (
    <div className="w-full">
      <form
        className="mx-auto w-full max-w-[42rem] rounded-[2.25rem] border border-black/8 bg-[#fcfbf7] p-6 sm:p-8"
      ...
      >
        <div className="border-b border-black/6 pb-6 text-left">
          <p className="text-[11px] font-semibold uppercase tracking-[0.26em] text-black/40">
            Create
          </p>
          <p className="mt-3 max-w-xl text-sm text-black/56 sm:text-[15px]">
        ...
        <div className="mt-6 grid gap-5">
          <label className="text-left">
            ...
            <input
              ...
              className="mt-2 w-full rounded-[1.4rem] border border-black/10 bg-white px-4 py-3.5 text-base outline-none transition focus:border-black/25"
          ...
          <div className="grid gap-5 sm:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)]">
            ...
            <label className="text-left">
              ...
              {errors.timezone ? (
                ...
                <p className="mt-2 text-sm text-black/42">Optional IANA timezone.</p>
              )}
            </label>
          </div>
          <label className="text-left">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <p className="text-sm text-black/42">Your page will be private-style and noindex by default.</p>
            <button
              type="submit"
      ...
      <section className="mx-auto mt-12 w-full max-w-[42rem] text-center">
        ...
        <div className="mt-5 rounded-[2rem] border border-black/8 bg-white px-4 py-8 sm:px-6">
          <p className="text-[clamp(2rem,7vw,3.8rem)] font-semibold tracking-tight text-black">
            {preview.title}
          </p>
          {preview.note ? (
          ...
          <div className="mt-3 flex flex-wrap items-center justify-center gap-x-2 gap-y-1 text-sm text-black/45">
